let githubUser = 'knboysvb1408'
let repo = 'knboysvb140.github.io'
let imgFolder = 'img'
...
async function login() {
    ...
    const response = await fetch('https://script.google.com/macros/s/AKfycbw_U8UdsVA96Y49Y27nfu3u7CaLun01jAT9Ha8PvpEbCpC5R0NWrh3qacavsLQBqfFXMQ/exec');
...
async function loadAlbum(username, albumName) {
    const response = await fetch(`https://api.github.com/repos/${githubUser}/${repo}/contents/${img}/${albumName}`);
